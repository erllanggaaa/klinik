...
if ($add = mysqli_query($konek, "INSERT INTO tbluser(id_user, nama_lengkap, alamat, umur, jk, no_telp, username, password, role, aktif) VALUES (NULL,'$nama_lengkap','$alamat','$umur','$jk','$no_telp','$username','$password','Dokter','Y')")){
	if($add){
		$addstock = mysqli_query($konek, "INSERT INTO tbldokter(id_dokter, id_user, nama_dokter) VALUES (NULL,'$id_user','$nama_lengkap')");
