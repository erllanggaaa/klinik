...
<html lang="en">
  <head>
    ...
    <title>Klinik Mitra Medika Dashboard - Tambah Data Dokter</title>
...
<div class="x_content">
<br />
<form action="simpan-dokter" method="post" data-parsley-validate class="form-horizontal form-label-left">
