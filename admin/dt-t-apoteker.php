...
$user = mysqli_query($konek, "SELECT * FROM tbluser WHERE id_user ORDER BY id_user DESC");
...
<html lang="en">
  ...
  <link rel="shortcut icon" href="../assets/images/favicon.png" />
    ...
    <title>Klinik Mitra Medika Dashboard - Tambah Data Apoteker</title>
...
<div class="x_content">
<br />
<form action="simpan-apoteker" method="post" data-parsley-validate class="form-horizontal form-label-left">
<div class="item form-group">
<label class="col-form-label col-md-2 col-sm-2 label-align">Nama Lengkap <span class="required text-danger">*</span>
</label>
<div class="col-md-5 col-sm-5 ">
<input type="hidden" required="required" name="id_user" class="form-control" value="<?php echo $row['id_user']; ?>" autocomplete="off">
