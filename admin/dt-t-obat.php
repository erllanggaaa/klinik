...
<html lang="en">
  <head>
    ...
    <title>Klinik Mitra Medika Dashboard - Tambah Data Obat</title>
...
<div class="x_content">
<br />
<form action="simpan-data-obat" method="post" data-parsley-validate class="form-horizontal form-label-left">
<div class="item form-group">
<label class="col-form-label col-md-2 col-sm-2 label-align">Nama Obat <span class="required text-danger">*</span>
</label>
<div class="col-md-5 col-sm-5 ">
<input type="text" required="required" name="nama_obat" class="form-control" autocomplete="off">
</div>
</div>
<div class="item form-group">
...
<div class="col-md-5 col-sm-5 ">
<input type="number" name="stok_obat" required="required" class="form-control" autocomplete="off">
</div>
</div>
<div class="item form-group">
...
<div class="col-md-5 col-sm-5 ">
<input type="text" name="harga_obat" required="required" class="form-control" autocomplete="off">
</div>
</div>
