...
<html lang="en">
  ...
  <link rel="shortcut icon" href="../assets/images/favicon.png" />
    ...
    <title>Klinik Mitra Medika Dashboard - History Rekam Medis</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="../pasien/dashboard" class="site_title"><span>Klinik Mitra Medika</span></a>
            </div>
            ...
            <?php
            include("../pasien/includes/sidebar_menu.php");
            ?>
        ...
        <?php
        include("../pasien/includes/top_navigation.php");
        ?>
...
$id = $_SESSION['pasien']['id_user'];
        $rekammedis = mysqli_query ($konek, "SELECT tblrekammedis.id_rekammedis, tblrekammedis.tgl_periksa, tblrekammedis.obat_1, tblrekammedis.obat_2, tblrekammedis.obat_3, tblrekammedis.obat_4, tblrekammedis.obat_5, tblrekammedis.keterangan, tbluser.nama_lengkap, tbldokter.nama_dokter, tblpembayaran.id_pembayaran, tblpembayaran.total_bayar, tblpembayaran.status FROM tblrekammedis
          ...
          WHERE tblrekammedis.id_user = '$id' and tblpembayaran.status = 'Lunas' ORDER BY tblrekammedis.id_user");
            if($rekammedis == false){
...
<?php
include("../pasien/includes/footer.php");