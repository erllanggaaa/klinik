...
<html lang="en">
  ...
  <link rel="shortcut icon" href="../assets/images/favicon.png" />
    ...
    <title>Klinik Mitra Medika Dashboard - Data Rekam Medis</title>
...
<div class="x_panel">
<div class="x_title">
<h2>Data Rekam Medis</h2>&emsp;
                            <a href="tambah-rekam-medis">
...
<tbody>
<?php
        $rekammedis = mysqli_query ($konek, "SELECT tblrekammedis.id_rekammedis, tblrekammedis.tgl_periksa, tblrekammedis.obat_1, tblrekammedis.obat_2, tblrekammedis.obat_3, tblrekammedis.obat_4, tblrekammedis.obat_5, tblrekammedis.keterangan, tbluser.nama_lengkap, tbldokter.nama_dokter FROM tblrekammedis
          ...
          WHERE tblrekammedis.id_dokter ORDER BY tblrekammedis.id_dokter DESC");
            if($rekammedis == false){
...
<td>Dr. <?php echo $hasilrm['nama_dokter']; ?></td>
...
<div class="input-group-append be-addon">
  <button type="button" data-toggle="dropdown" class="badge btn-default dropdown-toggle">&nbsp;</button>
    <div class="dropdown-menu">
      <a href="edit?id_rekammedis=<?php echo $hasilrm['id_rekammedis']; ?>" class="dropdown-item">Edit</a>
      </div>
    </div></td>
</tr>
<?php
